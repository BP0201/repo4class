...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2022-08-09T23:13:33.001750" />
  ...
  <link href="/media/css/fontawesome.css?83a3f40a" rel="stylesheet">
  <link rel="stylesheet" href="/media/css/bootstrap-4.4.1.min.css">
  <link rel="shortcut icon" href="/favicon.ico" />
  
    <link rel="stylesheet" type="text/css" href="/dyncss/base.css?83a3f40a">
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/pgformatter-v53-released-2493/">pgFormatter v5.3 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-08-09 by MigOps</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgadmin-4-v612-released-2490/">pgAdmin 4 v6.12 Released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-08-01 by pgAdmin Development Team</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pg_ivm-12-released-2489/">pg_ivm 1.2 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-07-28 by IVM Development Group</li>
              </ul>
            </li>
...
<!-- Blog -->
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5ow"> Crunchy Bridge Terraform Provider</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Elizabeth Garrett Christensen</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-08-08</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5ov"> Adam Wright</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5ou"> PostGIS 3.3.0rc1</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5ot"> How to Set Up NFS and Run PG on it</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;cary huang</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-08-05</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5os"> Milo</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5op"> pgAdmin User Survey 2022</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Dave Page</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-08-02</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5oo"> Beena Emerson</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Andreas &#x27;ads&#x27; Scherbaum</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-08-01</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5on"> Researching the Performance Puzzle</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5ok"> Comet and Shadow</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Federico Campoli</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-07-29</li>
            </ul>
          </div>
        </div>
 ...
 <!-- END SUBMIT A BUG -->
    ...
    <script src="/media/js/main.js?83a3f40a"></script>
