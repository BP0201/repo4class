...
router.get('/', authUser, requireLogin, async function(req, res, next) {
  try {
    ...
    // BUG #2 -- RETURNED ALL FIELDS == BIG NO NO :
 ...
 *
 */
// BUG #4 -- SHOULD NOT REQUIRE ADMIN TO UPDATE: (removed requireAdmin middleware)
router.patch('/:username', authUser, requireLogin, async function(
  ...
  try {
    ...
    // BUG #5: lets you put username,admin (DIDN'T FIND THIS ONE)
